...
update eg_city set preferences = (select cp.id from eg_city c, eg_citypreferences cp where municipalityname = 'Mapepe City Council' and c.name = cp.municipalityname);
