...
update eg_city set preferences = 1; --(select cp.id from eg_city c, eg_citypreferences cp where municipalityname = 'Mapepe City Council' and c.name = cp.municipalityname);
