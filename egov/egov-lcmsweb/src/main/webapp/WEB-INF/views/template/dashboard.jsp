...
<footer class="footer">
    <div style="margin-top: 20px;padding: 5px 19px;font-size: 12px;background: #F1F2F3;">Powered by <a href="http://zm4a.org/" target="_blank">Pamodzi Technologies/ITM Consult</a></div>
</footer>
</body>
