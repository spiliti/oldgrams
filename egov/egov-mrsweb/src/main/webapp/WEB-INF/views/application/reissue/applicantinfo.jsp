...
<label class="col-sm-2 control-label">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<form:input path="${applicant}.contactInfo.mobileNo" id="txt-phoneNo" type="text" cssClass="form-control low-width patternvalidation" data-pattern="number" minlength="9" maxlength="9" placeholder="" autocomplete="off" required="required" />
