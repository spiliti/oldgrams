      ...
      <s:hidden name="basicProperty.propertyOwnerInfoProxy[0].owner.type" id="basicProperty.propertyOwnerInfoProxy[0].owner.type"
       value="%{basicProperty.propertyOwnerInfoProxy[0].owner.type}"></s:hidden>
        <%-- <td class="blueborderfortd" align="center">
		 ...
		 <td class="blueborderfortd" align="center">
        	+260 <s:textfield name="basicProperty.propertyOwnerInfoProxy[0].owner.mobileNumber" title="Mobile number of the owner" maxlength="9" size="20" id="mobileNumber"  value="%{basicProperty.propertyOwnerInfoProxy[0].owner.mobileNumber}" 
        ...
        <s:iterator value="(basicProperty.propertyOwnerInfoProxy.size).{#this}" status="ownerStatus">
			<tr id="nameRow">
			 <s:hidden name="basicProperty.propertyOwnerInfoProxy[%{#ownerStatus.index}].owner.type" id="basicProperty.propertyOwnerInfoProxy[%{#ownerStatus.index}].owner.type"
			  ...
			  <td class="blueborderfortd" align="center">
        			+260 <s:textfield name="basicProperty.propertyOwnerInfoProxy[%{#ownerStatus.index}].owner.mobileNumber" maxlength="9" size="20" id="mobileNumber" value="%{basicProperty.propertyOwnerInfoProxy[#ownerStatus.index].owner.mobileNumber}" 
