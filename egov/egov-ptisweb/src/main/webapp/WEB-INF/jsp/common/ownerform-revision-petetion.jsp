			...
			<s:iterator
				...
				<tr id="nameRow">
					...
					<%-- <td class="blueborderfortd" align="center"><s:textfield
							...
							data-errormsg="NRC/INRIS no is mandatory!"
...
<script>
	function getAadharDetails(obj) {
		...
		if (aadharNo.length < 12) {
			jQuery(obj).val("");
			bootbox.alert("Invalid NRC/INRIS number !");
			return false;
		}
		jQuery
				.ajax({
					...
					success : function(response) {
						...
						if (userInfoObj.uid == aadharNo) {
							...
							jQuery(
									...
									.attr('readonly', false);
							if (aadharNo != "NaN") {
								bootbox.alert("NRC/INRIS number is not valid");
							}
						}
					...
					error : function() {
						jQuery(
								...
								.val("");
						alert("Invalid NRC/INRIS number or no details available with this NRC/INRIS number!");
						return false;
					}
				});
	}
